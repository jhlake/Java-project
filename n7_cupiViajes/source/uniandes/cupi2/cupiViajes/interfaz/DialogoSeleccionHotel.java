...
/**
 * Di�logo para seleccionar un hotel para reservar.
 */
public class DialogoSeleccionHotel extends JDialog implements ActionListener
{
    ...
    /**
     * Constante que representa el cambio en la selecci�n del combo box ciudad.
     */
    private final static String COMBO_CIUDAD = "Combo ciudad";

    /**
     * Constante que representa el cambio en la selecci�n del combo box hotel.
     */
    ...
    /**
     * Constructor del di�logo con la informaci�n del hotel.
    ...
    /**
     * Manejo de los eventos de los combo box y del evento generado por el bot�n.
