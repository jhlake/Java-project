...
public class Antecedente
{
    ...
    public void cambiarCondena( int pAnhosCondena ) throws Exception
    {
    	...
    	if(gravedad == LEVE)
    	{
    		if(pAnhosCondena <= 0 || pAnhosCondena > MAXIMO_ANHOS_CONDENA_LEVE)
    		{
    	...
    	{
    		if(pAnhosCondena <= MAXIMO_ANHOS_CONDENA_LEVE || pAnhosCondena > MAXIMO_ANHOS_CONDENA_GRAVE)
    		{
    	...
    	{
    		if(pAnhosCondena < MINIMO_ANHOS_CONDENA_MUY_GRAVE)
    		{
