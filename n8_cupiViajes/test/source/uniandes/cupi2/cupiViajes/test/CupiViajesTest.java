...
public class CupiViajesTest extends TestCase
{
    ...
    protected void setUp( )
    {
        ...
        {
            //TODO 2.e Incluya la instrucci�n para indicar que el programa NO deber�a lelgar ac�
    ...
    public void testAgregarReserva2( )
    {
        ...
        {
            //TODO Parte 2.e Verifique que la cedula guardada en la excepci�n es la c�dula repetida
            assertEquals("El número de cédula guardada en la excepción es incorrecto.", "1", e.darCedula( ));
        }
    }
