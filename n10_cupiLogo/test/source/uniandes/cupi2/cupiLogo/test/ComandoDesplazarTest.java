 ...
 */
public class ComandoDesplazarTest extends TestCase
{
    // -----------------------------------------------------------------
    // Atributos
    // -----------------------------------------------------------------
    ...
    /**
     * ComandoDesplazar donde se harán las pruebas.
     */
    private ComandoDesplazar comando;
    ...
    /**
     * <b> Escenario 1 :</b> Construye un nuevo ComandoDesplazar.
     */
    private void setupEscenario1( )
    {
        comando = new ComandoDesplazar( 25, ComandoDesplazar.ADELANTE );
        ...
        tablero.darTortuga( ).reiniciarTortuga( );
    }

    /**
     * Prueba 1: Prueba el método constructor de la clase ComandoDesplazar. <br>
     * <b>Métodos a probar:</b> <br>
     * darNombre<br>
     * <b> Casos de prueba: <b><br>
     * 1. El nombre del comando corresponde al de la constante de ComandoDesplazar.
     */
    public void testComando( )
    {
        setupEscenario1( );
        assertEquals( "El nombre del comando no es el correcto.", ComandoDesplazar.COMANDO, comando.darNombre( ) );
    }
     ...
     * darTortuga<br>
     * <b> Casos de prueba: <b><br>
     * 1. Las coordenadas de la tortuga cambiaron con el desplazamiento.
     */
    public void testEjecutar( )
    {
        setupEscenario1( );
        comando.ejecutar( tablero.darTortuga( ),graphics );
        assertEquals( "El comando debió modificar la posición de la tortuga en X.", tablero.darTortuga( ).darXActual( ), 75 );
    ...
    public void testGuardar( )
    {
        ...
        String nombreArchivo = "test/data/pruebaComandoDesplazar.txt";
        ...
        try
        {
            ...
            if( linea != null )
            {
                String textoComando = comando.darNombre( ) + " 25.0" + " 0";
