...
/**
 * Clase usada para verificar que los métodos de la clase ComandoGirar estén correctamente implementados.
 */
public class ComandoGirarTest extends TestCase
{
    ...
    /**
     * ComandoGirar donde se harán las pruebas.
     */
    ...
    /**
     * Prueba 1: Prueba el método constructor de la clase ComandoGirar. <br>
     ...
     * darTortuga<br>
     * <b> Casos de prueba: <b><br>
     * 1. La orientación de la tortuga cambió con el desplazamiento.
     */
    public void testEjecutar( )
    {
        setupEscenario1( );
        comando.ejecutar( tablero.darTortuga( ), graphics );
        assertEquals( "El comando debió modificar el color del tablero", tablero.darTortuga( ).darOrientacion( ), 120.0, 0.1 );
    }
