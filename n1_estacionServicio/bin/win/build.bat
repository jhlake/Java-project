...
REM ---------------------------------------------------------
cd source
javac -nowarn -classpath -d ../classes/ uniandes/cupi2/estacionServicio/mundo/*.java
javac -nowarn -classpath -d ../classes/ uniandes/cupi2/estacionServicio/interfaz/*.java
