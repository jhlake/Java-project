...
public class Jaula
{
    ...
    public void agregarAnimal( String pNombre, String pEspecie, String pTipo, String pHabitat, String pImagen )
    {
    	...
    	Animal anim = new Animal(pNombre, pEspecie, pTipo, pHabitat, pImagen);
    	animales.add(anim);
    ...
    public boolean eliminarAnimal( String pNombre )
    {
    	...
    	int i = 0;
    	while(i<animales.size() && !(elimino))
    	{
    		Animal animalA = animales.get(i);
    		if(animalA.darNombre().equals(pNombre))
    		{
    			animales.remove(i);
    			elimino = true;
    		}
    ...
    public boolean hayAnimalCarnivoro( )
    {
    	...
    	int i = 0;
    	boolean hayCarnivoro = false;
    	while(!hayCarnivoro)
    	{
    		if((animales.get(i)).darTipo().equals(Animal.CARNIVORO))
    		{
    			hayCarnivoro = true;
    		}
    		i++;
    ...
    public boolean existeAnimalEnJaula( String pNombre )
    {
    	...
    	while(!siHay)
    	{
    		if(( animales.get(i)).darNombre().equals(pNombre))
    		{
    			siHay = true;
    		}
    		i++;
    ...
    public boolean puedeAgregarPorTipoYEspecie( String pEspecie, String pTipo )
    {
    	...
    	boolean puede = false;
    	int i = 0;
    	boolean espExiste = true;
    	if(pTipo.equals(Animal.CARNIVORO))
    	{
    		while(i<darCantidadAnimales() && espExiste)
    		{
    			if(!(( animales.get(i)).darEspecie().equals(pEspecie)))
    			{
    				espExiste = false;
    			}
    			i++;
    	...
    	if((pTipo.equals(Animal.HERBIVORO) && (!hayAnimalCarnivoro() || darCantidadAnimales() == 0)) || (pTipo.equals(Animal.CARNIVORO) && (espExiste || darCantidadAnimales() == 0)))
    	{
    		puede =true;
    	}
    	return puede;
